...
* Nodes are ordered according to their current nominal individual ore_token ratio (NICR),
* which is like the ICR but without the price, i.e., just ore_token / debt.
*
...
* relative to it's peers, as rewards accumulate, as long as it's raw ore_token and debt have not changed.
* Thus, Nodes remain sorted by current NICR.
*
* Nodes need only be re-inserted upon a Trove operation - when the owner adds or removes ore_token or debt
* to their position.
*
...
*   The list relies on the property that ordering by ICR is maintained as the NEON_TOKEN:USD price varies.
*
...
contract SortedTroves is Ownable, CheckContract, ISortedTroves {
    ...
    // BorrowerOperationsAddressChanged, NodeAdded, NodeRemoved are inherited from ISortedTroves
