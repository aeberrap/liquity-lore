...
interface ITroveManager is ILiquityBase {
    ...
    function getPendingNEON_TOKENReward(address _borrower) external view returns (uint);
    ...
    function getRedemptionFeeWithDecay(uint _NEON_TOKENDrawn) external view returns (uint);
